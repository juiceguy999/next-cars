    ...
    <div className="rounded-xl overflow-hidden relative bg-darkGray">
      ...
      <div className="py-3 px-4 text-white">
        ...
        <div className="flex gap-4 items-center mt-4">
          <button onClick={() => handlePublishCar(car._id)} className="bg-dark border text-[#0f0] font-semibold border-borderGray rounded-lg px-3 py-2">Publish</button>
          <button onClick={() => handleDeleteCar(car._id)} className="bg-dark border text-[#f00] font-semibold border-borderGray rounded-lg px-3 py-2">Delete</button>
        </div>
      </div>
    </div>
  )
